...
<div class="table-container">
    ...
    <div class="table-header">
        ...
        <div class="table-actions">
            <a href="{{ route('resepsionis.datamaster.pet.create') }}" class="add-btn">+ Tambah Hewan</a>
        ...
        <tbody>
            @forelse($pets as $index => $pet)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('resepsionis.datamaster.pet.edit', $pet->idpet) }}" class="btn-action btn-edit">Edit</a>
                        <a href="{{ route('resepsionis.datamaster.pet.delete', $pet->idpet) }}" class="btn-action btn-delete">Hapus</a>
                    </td>
                </tr>
            @empty
                <tr>
