...
<div class="table-container">
    ...
    {{-- Form Tambah Hewan --}}
    <form action="{{ route('admin.datamaster.pet.store') }}" method="POST" class="add-form">
        @csrf
        <div class="form-group">
            ...
            <select name="jenis_kelamin" required class="search-box" style="margin-top: 10px;">
            ...
            <select name="idpemilik" required class="search-box" style="margin-top: 10px;">
            ...
            <select name="idras_hewan" required class="search-box" style="margin-top: 10px;">
