...
class PetController extends Controller
{
    public function index()
    {
        ...
        return view('resepsionis.datamaster.pet.index', compact('pets'));
    }
    ...
    public function create()
    {
        ...
        return view('resepsionis.datamaster.pet.create', compact('pemilik', 'rasHewan'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('resepsionis.datamaster.pet.index')
    ...
    public function edit($id)
    {
        ...
        $pemilik = Pemilik::with('user')->get();
        $rasHewan = RasHewan::all();
        return view('resepsionis.datamaster.pet.edit', compact('pet', 'pemilik', 'rasHewan'));
    }
        ...
        public function delete($id)
    {
        ...
        return view('resepsionis.datamaster.pet.delete', compact('pet'));
    }
}
